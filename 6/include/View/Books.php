...
?>
<p><a href="?page=books&oper=add" class="btn btn-info" role="button">Add</a></p>
...
<?		endforeach ?>
		...
		<td>
			...
			<a href="?page=books&oper=remove&id=<?= $item['id'] ?>"><span class="glyphicon glyphicon-trash"></span></a>
		</td>
	</tr>
<?	endforeach;?>
</table>
